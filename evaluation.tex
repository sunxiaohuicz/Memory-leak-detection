...
\begin{tabular}{|c|c|c|c|c|}
\hline
\textbf{Program}& \tabincell{c}{\textbf{Size}\\\textbf{(Kloc)}}             &            \tabincell{c}{\textbf{CppCheck}\\\textbf{(Time)}} &      \tabincell{c}{\textbf{RLDetector}\\\textbf{(Time)}} & \tabincell{c}{\textbf{PMLChecker}\\\textbf{(Time)}}\\
\hline
...
\hline
branch1	 &	YES & NO & YES & YES\\
\hline
branch2    & YES & YES & YES & YES\\
\hline
loop1	 & NO &	NO & YES & YES\\
\hline
loop2    & YES & NO & YES & YES\\
\hline
chainBranch1 & NO & NO & YES & YES\\
\hline
chainBranch2 &	NO	& NO & YES & YES\\
\hline
chainLoop1	 & YES & YES & NO & YES\\
\hline
chainLoop2	 & YES& YES & NO & YES\\
\hline
nestingBranch	 & NO & NO & YES & YES\\
\hline
nestingLoop& NO & NO & YES & YES\\
\hline
\end{tabular}
\end{table}
...
list3	 &	NO	& YES & NO & YES\\
\hline
struct1	 & NO & YES & NO & YES\\
\hline
struct2	 & NO & YES & NO & YES\\
\hline
arrayStruct1	 & NO & YES & YES & YES\\
\hline
arrsyStruct2  & YES & YES & YES & YES\\
\hline
\end{tabular}
\end{table}
