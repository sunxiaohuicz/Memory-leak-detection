...
\IEEEauthorblockN{Xiaohui Sun\IEEEauthorrefmark{1},
                               ...
                               Naipeng Dong\IEEEauthorrefmark{4},                              
								Jing Xu\IEEEauthorrefmark{5},
...
\begin{tabular}{c c c c}                 
    \IEEEauthorrefmark{6}Department of Binhai & \IEEEauthorrefmark{1}\IEEEauthorrefmark{2}\IEEEauthorrefmark{3}\IEEEauthorrefmark{5}\IEEEauthorrefmark{7}Department of Computer and Control Engineering & \IEEEauthorrefmark{4}School of Computing\\
